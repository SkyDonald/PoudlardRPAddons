...
public class HudElementHotbarDefault extends HudElement {
    ...
    public void drawElement(AbstractGui gui, float zLevel, float partialTicks, int scaledWidth, int scaledHeight) {
        if (this.mc.playerController.getCurrentGameType() == GameType.SPECTATOR)
            ...
            gui.blit(i - 91 - 1 + this.mc.player.inventory.currentItem * 20, scaledHeight - 22 + posY - 1, 0, 22, 24,
                    22);
            ...
            for (int l = 0; l < 9; ++l) {
                ...
                this.renderHotbarItem(i1, j1, partialTicks, this.mc.player,
                        this.mc.player.inventory.mainInventory.get(l));
            }
