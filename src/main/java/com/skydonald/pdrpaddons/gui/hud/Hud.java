...
import static com.skydonald.pdrpaddons.gui.hud.element.HudElementType.*;
...
public abstract class Hud {
	 ...
	 */
	public void drawElement(HudElementType type, AbstractGui gui, float zLevel, float partialTicks, int scaledWidth,
			int scaledHeight) {
